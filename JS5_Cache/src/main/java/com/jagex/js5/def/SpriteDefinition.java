...
/**
 * Represents a {@link SpriteDefinition} which may contain one or more frames.
 * @author Graham
 * @author `Discardedx2
 */
public final class SpriteDefinition {
	...
	/**
	 * Decodes the {@link SpriteDefinition} from the specified {@link ByteBuffer}.
	 * @param buffer The buffer.
	 * @return The sprite.
	 */
	public static SpriteDefinition decode(ByteBuffer buffer) {
	 ...
	 */
	public SpriteDefinition(int width, int height) {
		this(width, height, 1);
	}
	 ...
	 */
	public SpriteDefinition(int width, int height, int size) {
		if (size < 1)
	...
	/**
	 * Encodes this {@link SpriteDefinition} into a {@link ByteBuffer}.
	 * <p />
